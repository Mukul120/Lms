...
const SignUpPage = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-100 to-indigo-200 flex items-center justify-center p-4 w-screen overflow-hidden">
            <div className="bg-white rounded-lg shadow-xl overflow-hidden w-full max-w-md transform transition-all duration-300 hover:scale-105">
                ...
                <form onSubmit={handleSubmit} className="p-8">
                    ...
                    <div className="text-center mt-6 text-sm opacity-0 animate-fade-in" style={{ animation: 'fadeIn 0.6s 0.5s forwards' }}>
                        <Link to={"/"} href="#" className="text-purple-500 hover:text-indigo-800 transition-colors duration-300">
